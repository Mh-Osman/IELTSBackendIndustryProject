...
def generate_ielts_feedback(task1_answer, task2_answer, question_data):
    ...
    system_prompt = """
    You are a Senior IELTS Writing Examiner with 15+ years of experience. Your grading is strict, academic, and adheres exactly to the official public band descriptors.
